            ...
            <tr>
              ...
              <div class="form-row">
                ...
                <label for="Option1">Option1</label>            
                  <input type="Option1" name="Option1" id="Option1" class="form-control"  placeholder="Option1">
                  <?php if (isset($err['option1'])) { ?>
           <span class="text-danger"><?php echo $err['option1']; ?></span> 
         <?php } ?>
                
              </div>
                <div class="form-group col-md-6">
                <label for="Option2">Option2</label>            
                  <input type="Option2" name="Option2" id="Option2" class="form-control"  placeholder="Option2">
                  <?php if (isset($err['option2'])) { ?>
           <span class="text-danger"><?php echo $err['option2']; ?></span> 
         <?php } ?>
              </div>
            </div>
             </td>
            ...
            <td>
              <div class="form-row">
                ...
                <label for="Option3">Option3</label>            
                  <input type="Option3" name="Option3" id="Option3" class="form-control"  placeholder="Option3">
                  <?php if (isset($err['option3'])) { ?>
           <span class="text-danger"><?php echo $err['option3']; ?></span> 
         <?php } ?>
              </div>
                <div class="form-group col-md-6">
                <label for="Option4">Option4</label>            
                  <input type="Option4" name="Option4" id="Option4" class="form-control"  placeholder="Option4">
                  <?php if (isset($err['option4'])) { ?>
           <span class="text-danger"><?php echo $err['option4']; ?></span> 
         <?php } ?>
              </div>
            </div>
          </td>
