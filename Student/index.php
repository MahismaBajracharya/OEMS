  ...
  if (isset($_POST['gender']) && !empty($_POST['gender'])) {
   ...
   //form validation for roll_no
    ...
    if (count($err) == 0) {
      ...
      //sql to update data
      $sql ="update student set name='$name',email='$email',phone='$phone',gender='$gender',class='$class',roll_no='$roll_no' where student_id=$student_id";
      //query execute
       $connect->query($sql);
 ...
 <div class="container-fluid ml-auto">
    ...
    <div class="card" >
      <div class="card-header" align="left"style='background-color: rgb(232, 255, 253,0.5);padding-left: 4rem;'>
        <p class="text-dark">UserName: <?php echo $_SESSION['student_name'] ?><br></p>
        <p class="text-dark">(123) 456-7890</p>
        <p class="text-dark"><?php echo $_SESSION['student'] ?></p>
    ...
    <div class="card" >
      <div class="card-header" >
        ...
        <img src="../images/lock.jpg" height="90rem" width="auto">
         <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?student_id=<?php echo $student_id ?>">
            <fieldset>
