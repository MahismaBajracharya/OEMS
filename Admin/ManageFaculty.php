...
<div class="container" style="margin-top:7rem;">
  <h4>Information</h4>
    <hr>
        ...
        <tr class="table-info">
         ...
         <tbody>
            ...
            <tr>
              ...
              <td class='text-center' style="color:rgb(154, 218, 227);"><a  style="color:rgb(154, 218, 227);"href="http://localhost/exam/Admin/ViewFaculty.php?faculty_id=<?php echo $d['faculty_id'] ?>">
      ...
      <td class='text-center' id="delete" name="delete" style="color:rgb(154, 218, 227);"><a  style="color:rgb(154, 218, 227);"href="http://localhost/exam/Admin/DeleteFaculty.php?faculty_id=<?php echo $d['faculty_id'] ?>">
