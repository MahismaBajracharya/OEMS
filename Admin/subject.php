...
//query to select data from table subject
$sql = "select * from subject, faculty where subject.faculty_id=faculty.faculty_id";
	...
	<h4>Information</h4>
        ...
        <tr class="table-info">
         ...
         <tbody>
			...
			<td class='text-center' style="color:rgb(154, 218, 227);"><a  style="color:rgb(154, 218, 227);"href="http://localhost/exam/Admin/DeleteSubject.php?id=<?php echo $d['id'] ?>" onclick="return confirm('Please click on OK to continue.');">
