...
<?php
 ...
 <?php
   ...
   if(isset($_FILES['image']['error']) && $_FILES['image']['error']==0){
    ...
    if(in_array($_FILES['image']['type'], $types)){
      if($_FILES['image']['size']<=100*1024){
        ...
        if(file_exists('../images/admin/' .$_FILES['image']['name'])){
          $image_name=uniqid() . '_' . $_FILES['image']['name'];
        }
        //upload file
        if(move_uploaded_file($_FILES['image']['tmp_name'], '../images/admin/' .$image_name)){
          /*echo "File upload success";
          echo $image_name;*/
          $image='http://localhost/exam/images/admin/' . $image_name;
          //echo $image;
  ...
  if (count($erri) == 0) {
      ...
      //sql to update data
      $sql ="update admin set photo='$image' where admin_id=$admin_id";
      //query execute
       $connect->query($sql);
 ...
 <div class="container-fluid ml-auto">
    <div class="row">
      ...
      <div class="card-header"> 
        <h4 align="center" ><a id="about">Hello!</a><br></h4>
          <hr>
        <img src="<?php echo $admin['photo'];?>" class="rounded-circle  outerbox w-100" alt="User">
    ...
    <div class="card" >
      <div class="card-header" align="left"style='background-color: rgb(232, 255, 253,0.5);padding-left: 4rem;'>
        <p class="text-dark">UserName: <?php echo $_SESSION['admin_name'] ?><br></p>
        <p class="text-dark">(123) 456-7890</p>
        <p class="text-dark"><?php echo $_SESSION['admin'] ?></p>
    ...
    <div class="modal-content card">
      <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
        ...
        <div class="modal-header text-center pb-4">
          ...
          <!-- form starts-->
          <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?admin_id=<?php echo $admin_id ?>" enctype="multipart/form-data">
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?admin_id=<?php echo $admin_id ?>" enctype="multipart/form-data" >
            <fieldset>
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control"  name="name" id="name" value="<?php echo $admin['name'];?>"aria-describedby="helpId" placeholder="Enter your name">
         ...
         <?php } ?>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="email" name="email" value="<?php echo $admin['email'];?>" id="email" class="form-control"  placeholder="abc@gmail.com">
         ...
         <?php } ?>
                ...
                <div class="form-group col-md-6"> 
                  ...
                  <input type="number" name="phone" value="<?php echo $admin['phone'];?>" id="phone" class="form-control"  placeholder="XXXXXXXXXX">
    ...
    <div class="card" >
      <div class="card-header" >
        <?php if(isset($Passsuccess)){ ?>
              ...
              <?php } ?>
         <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?admin_id=<?php echo $admin_id ?>">
            <fieldset>
